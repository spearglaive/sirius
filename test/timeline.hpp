...
#include "sirius/timeline/recreate.hpp"
...
namespace acma::test {
	using intermediate_timeline = sl::tuple<
		...
		acma::recreate_to_fit<::buffer_id::all_ones_gpu_side, ::buffer_id::all_ones_cpu_side, false>,

		acma::fill<::buffer_id::all_ones_gpu_side, ~sl::uint32_t{0}>,
