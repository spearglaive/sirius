...
constexpr acma::buffer_config_table<buffer_id::num_buffer_ids> buffer_configs{{{
	{buffer_id::dispatch_commands, {acma::memory_policy::shared, acma::access_policy::gpu_only, acma::buffer_usage_policy::dispatch_commands, 0, sizeof(acma::dispatch_command_t)}},
	{buffer_id::counts, {acma::memory_policy::shared, acma::access_policy::gpu_only, acma::buffer_usage_policy::draw_count | acma::buffer_usage_policy::generic, 0, sizeof(acma::draw_count_t) + sizeof(sl::uint32_t)}},
	{buffer_id::draw_commands, {acma::memory_policy::shared, acma::access_policy::gpu_only, acma::buffer_usage_policy::draw_commands, 0, 256 * sizeof(acma::indexed_draw_command_t)}},
	{buffer_id::single_instance_draw_command, {acma::memory_policy::gpu_local, acma::access_policy::gpu_only, acma::buffer_usage_policy::draw_commands, 0, sizeof(acma::indexed_draw_command_t)}},


	{buffer_id::rectangle_indices, {acma::memory_policy::gpu_local, acma::access_policy::gpu_only, acma::buffer_usage_policy::index, 0, sizeof(std::uint16_t)}},
	{buffer_id::offset, {acma::memory_policy::gpu_local, acma::access_policy::gpu_only, acma::buffer_usage_policy::uniform, acma::shader_stage::compute, sizeof(std::uint16_t)}},
