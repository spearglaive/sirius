...
namespace acma::impl {
    ...
    struct make<vk::pipeline_layout<BindPoint, T, BufferConfigs, DescriptorArrayConfigs>> {
		template<typename RenderProcessT>
		SIRIUS_API result<vk::pipeline_layout<BindPoint, T, BufferConfigs, DescriptorArrayConfigs>> operator()(
			...
			sl::in_place_adl_tag_type<vk::pipeline_layout<BindPoint, T, BufferConfigs, DescriptorArrayConfigs>> = sl::in_place_adl_tag<vk::pipeline_layout<BindPoint, T, BufferConfigs, DescriptorArrayConfigs>>
		) const noexcept;
	};
}
